...
if (isset($_POST['save'])) {
  ...
  $q4 = "AND bongkar_log.special_case LIKE '" . $q4."'";  

  $statement = "
  SELECT bongkar_log.*, tebangan.*  
  FROM bongkar_log   
  JOIN tebangan ON tebangan.tebangan_id=bongkar_log.tebangan_id
  WHERE (bongkar_log.bongkar_date BETWEEN '".$from."' AND '".$to."') ".$q3." ".$q4." AND bongkar_log.tebangan_id in (SELECT tebangan_id FROM tebangan WHERE ".$q2." )";   
