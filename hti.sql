...
--
ALTER TABLE `tebangan_bongkar`
  MODIFY `tebangan_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `operasional`
  ADD CONSTRAINT `operasional_fk0` FOREIGN KEY (`truk_id`) REFERENCES `truk` (`truk_id`),
  ADD CONSTRAINT `operasional_fk1` FOREIGN KEY (`tebangan_id`) REFERENCES `tebangan` (`tebangan_id`);
